    ...
    $.fn.gantt = function (options) {
        ...
        var core = {
            ...
            render: function (element) {
                ...
                element.scrollNavigation.panelMargin = parseInt($dataPanel.css("margin-right").replace("px", ""), 10);
                ...
                if (settings.scrollToToday) {
                    ...
                    if (element.hPosition !== 0) {
                        ...
                        $dataPanel.css({"margin-right": element.hPosition});
            ...
            createProgressBar: function (days, label, desc, classNames, dataObj) {
                ...
                if (desc) {
                    bar
                        ...
                        .mousemove(function (e) {
                            $(".fn-gantt-hint").css("right", e.pageX);
                        ...
                        $.each(entry.values, function (j, day) {
                            ...
                            switch (settings.scale) {
                                ...
                                case "hours":
                                    ...
                                    _bar.css({'top': top, 'right': Math.floor(cFrom)});
            ...
            navigateTo: function (element, val) {
                ...
                switch (val) {
                    case "begin":
                        $dataPanel.animate({"margin-right": "0px"}, "fast", shift);
                    ...
                    case "end":
                        ...
                        $dataPanel.animate({"margin-right": "-" + mLeft}, "fast", shift);
                        break;
                    case "now":
                        ...
                        curMarg = $dataPanel.css("margin-right").replace("px", "");
                        ...
                        $dataPanel.animate({"margin-right": val}, "fast", shift);
            ...
            navigatePage: function (element, val) {
                if ((element.pageNum + val) >= 0 &&
                    ...
                    core.waitToggle(element, function () {
                        element.pageNum += val;
                        element.hPosition = $(".fn-gantt .dataPanel").css("margin-right").replace("px", "");
            ...
            zoomInOut: function (element, val) {
                core.waitToggle(element, function () {
                    ...
                    var $rightPanel = $(element).find(".fn-gantt .rightPanel");
                    var $dataPanel = $rightPanel.find(".dataPanel");
                    element.hPosition = $dataPanel.css("margin-right").replace("px", "");
            ...
            sliderScroll: function (element, e) {
                ...
                if ((e.pageX >= bPos.left) && (e.pageX <= bPos.left + bWidth)) {
                    ...
                    pos = pos - wButton / 2;
                    $sliderBarBtn.css("right", pos);

                    mLeft = $dataPanel.width() - $rightPanel.width();

                    var pPos = pos * mLeft / bWidth * -1;
                    if (pPos >= 0) {
                        $dataPanel.css("margin-right", "0px");
                        element.scrollNavigation.panelMargin = 0;
                    } else if (pos >= bWidth - (wButton * 1)) {
                        $dataPanel.css("margin-right", mLeft * -1);
                        element.scrollNavigation.panelMargin = mLeft * -1;
                    } else {
                        $dataPanel.css("margin-right", pPos);
            ...
            scrollPanel: function (element, delta) {
                ...
                if (_panelMargin > 0) {
                    element.scrollNavigation.panelMargin = 0;
                    $(element).find(".fn-gantt .dataPanel").css("margin-right", element.scrollNavigation.panelMargin);
            ...
            synchronizeScroller: function (element) {
                ...
                var hPos = $dataPanel.css("margin-right") || 0;
                if (hPos) {
            ...
            repositionLabel: function (element) {
                setTimeout(function () {
                    ...
                    if (settings.useCookie) {
                        $.cookie(settings.cookieKey + "ScrollPos", $dataPanel.css("margin-right").replace("px", ""));
                    }
                }, 500);
            },
