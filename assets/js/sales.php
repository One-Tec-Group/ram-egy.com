...
<script type="text/javascript">
    ...
    $('body').on('change', 'input[name="decrease"],select.tax', function () {
        calculate_total();
    });
    ...
    function calculate_total() {
        ...
        total_discount_calculated = 0,
            ...
            decrease = $('input[name="decrease"]').val(),
        ...
        $('.decrease').html(decrease.toFixed(2) + hidden_input('decrease', decrease.toFixed(2)))
