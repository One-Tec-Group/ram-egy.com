...
jQuery.fn.extend({
    Calculadora: function (op) {
        ...
        defaults = {
            ...
            ClaseBotones: 'btn3d btn-sm btn-block btn btn-',
            txtSalida: idInstancia + 'txtResultado',
            ClasetxtSalida: 'form-control txtr',
            InputBorrar: idInstancia + 'Borrar',
            ClaseInputBorrar: 'btn3d btn btn-danger btn-sm btn-block',
        ...
        $(LaCalculadora).html('<div class="panel panel-primary btn-block calculadoraBase  mtop">' + op.TituloHTML + '<div class="panel-body"><div class="" style="margin-bottom: 10px;">' + $(LaCalculadora).html() + '</div></div> </div>');
