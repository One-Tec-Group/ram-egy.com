<div class="panel panel-custom">
    ...
    <div class="modal-body wrap-modal wrap">
        ...
        <form action="<?= base_url() ?>client/bugs/save_attachment"
            ...
            <div class="modal-body clearfix">
                ...
                if (!empty($bugs_details->bug_id)) {
                    echo $bugs_details->bug_id;
                }
                ?>" class="form-control">
                <div class="form-group">
                    <div class="col-sm-12">
            ...
            <div class="modal-footer">
                ...
                <button id="file-save-bug-btn" type="submit" disabled="disabled"
