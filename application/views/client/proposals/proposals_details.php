...
<div class="row mb">
    ...
    <div class="col-sm-8">
        ...
        if ($proposals_info->status != 'accepted') {
            ...
            <a class="btn btn-xs btn-purple"
               href="<?= base_url() ?>client/proposals/change_status/accepted/<?= $proposals_info->proposals_id ?>">
                <i class="fa fa-check"></i> <?= lang('accepted') ?></a>

            <a class="btn btn-xs btn-warning"
               href="<?= base_url() ?>client/proposals/change_status/declined/<?= $proposals_info->proposals_id ?>"><i
    ...
    <div class="col-sm-4 pull-right">
        ...
        <a href="<?= base_url() ?>client/proposals/pdf_proposals/<?= $proposals_info->proposals_id ?>"
