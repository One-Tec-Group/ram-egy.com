...
<div class="row mb">
    ...
    <div class="col-sm-8">
        ...
        <a class="btn btn-xs btn-purple"
           href="<?= base_url() ?>client/estimates/change_status/accepted/<?= $estimates_info->estimates_id ?>">
            <i class="fa fa-check"></i> <?= lang('accepted') ?></a>

        <a class="btn btn-xs btn-warning"
           href="<?= base_url() ?>client/estimates/change_status/declined/<?= $estimates_info->estimates_id ?>"><i
                class="fa fa-close"></i> <?= lang('declined') ?></a>
    </div>
    <div class="col-sm-4 pull-right">
        ...
        <a href="<?= base_url() ?>client/estimates/pdf_estimates/<?= $estimates_info->estimates_id ?>"
