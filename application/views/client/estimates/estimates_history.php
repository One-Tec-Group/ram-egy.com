    ...
    <div class="col-sm-3">
        <div class="panel panel-custom">
            <div class="panel-heading">
                <a style="margin-top: -5px" href="<?= base_url() ?>clientestimates/index/edit_estimates"
                        ...
                        <ul class="nav"><?php
                            if (!empty($all_estimates_info)) {
                                foreach ($all_estimates_info as $key => $v_estimate) {
                                    ...
                                    ?>">
                                        <a href="<?= base_url() ?>clientestimates/index/estimates_details/<?= $v_estimate->estimates_id ?>">
