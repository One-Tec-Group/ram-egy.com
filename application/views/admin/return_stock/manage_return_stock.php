...
<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        <li class="<?= $active == 1 ? 'active' : ''; ?>"><a href="#manage"
                                                            data-toggle="tab"><?= lang('manage') . ' ' . lang('return_stock') ?></a>
        </li>
        <li class="<?= $active == 2 ? 'active' : ''; ?>"><a href="#create"
                                                            data-toggle="tab"><?= lang('new') . ' ' . lang('return_stock') ?></a>
        </li>
    </ul>
                ...
                <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
                                                    ...
                                                    <select class="form-control select_box" style="width: 100%"
                                                        ...
                                                        if (!empty($all_supplier)) {
                                                            foreach ($all_supplier as $v_supplier) {
                                                                if (!empty($return_stock_info->supplier_id)) {
                                                                    $supplier_id = $return_stock_info->supplier_id;
                                                                }
                                                                ?>
                                        ...
                                        <div class="col-sm-7">
                                            <div class="checkbox c-radio needsclick">
                                                <label class="needsclick">
                                                    <input id="" <?php
                                                    if (!empty($return_stock_info->permission) && $return_stock_info->permission == 'all') {
                                                        echo 'checked';
                                                    ...
                                                    <div class="checkbox c-checkbox needsclick">
                                                        <label class="needsclick">
                                                            <input type="checkbox"
                                                                <?php
                                                                if (!empty($return_stock_info->permission) && $return_stock_info->permission != 'all') {
                                                                    $get_permission = json_decode($return_stock_info->permission);
                                        ...
                                        <div class="col-sm-7">
                                            <label class="radio-inline c-radio">
                                                <input type="radio" value="Yes" name="update_stock"
                                                    <?php if (isset($return_stock_info) && $return_stock_info->update_stock == 'Yes') {
                                                        echo 'checked';
                                                    } elseif (empty($return_stock_info)) {
                                                        echo 'checked';
                                                    } ?>>
                                            ...
                                            <label class="radio-inline c-radio">
                                                <input type="radio" value="No"
                                                       name="update_stock" <?php if (isset($return_stock_info) && $return_stock_info->update_stock == 'No') {
                                                    echo 'checked';
                                                } ?>>
                    ...
                    <div class="row bt">
                                ...
                                <div class="col-sm-8">
                                    <label class="radio-inline c-radio">
                                        <input type="radio" value="qty" id="<?php echo lang('qty'); ?>"
                                            ...
                                            <?php if (isset($return_stock_info) && $return_stock_info->show_quantity_as == 'qty') {
                                                echo 'checked';
                                    ...
                                    <label class="radio-inline c-radio">
                                        <input type="radio" value="hours" id="<?php echo lang('hours'); ?>"
                                               name="show_quantity_as" <?php if (isset($return_stock_info) && $return_stock_info->show_quantity_as == 'hours' || isset($hours_quantity)) {
                                            echo 'checked';
                                        } ?>>
                                    ...
                                    <label class="radio-inline c-radio">
                                        <input type="radio" value="qty_hours"
                                               ...
                                               name="show_quantity_as"
                                            <?php if (isset($return_stock_info) && $return_stock_info->show_quantity_as == 'qty_hours' || isset($qty_hrs_quantity)) {
                                                echo 'checked';
                                            } ?>>
                                        <span
                        ...
                        <div class="table-responsive s_table">
                            <table class="table invoice-items-table items">
                                ...
                                <?php if (isset($return_stock_info)) {
                                    echo form_hidden('isedit', $return_stock_info->return_stock_id);
                                }
                                ?>
                                <tr class="main">
                                    <td></td>
                        ...
                        <textarea name="item_desc" class="form-control"
                                ...
                                <?php if (isset($return_stock_info) || isset($add_items)) {
                                    $i = 1;
                                    $items_indicator = 'items';
                                    if (isset($return_stock_info)) {
                                        $add_items = $this->return_stock_model->ordered_items_by_id($return_stock_info->return_stock_id);
                                        $items_indicator = 'items';
                                    }
                                    ...
                                    foreach ($add_items as $item) {
                                        ...
                                        $invoice_item_taxes = $this->return_stock_model->get_invoice_item_taxes($item->items_id, 'return_stock');
                                        ...
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    ...
                                                    $discount_percent = 0;
                                                    if (isset($return_stock_info)) {
                                                        if ($return_stock_info->discount_percent != 0) {
                                    ...
                                    <tr>
                                        <td>
                                            <div class="row">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" data-parsley-type="number"
                                                           value="<?php if (isset($return_stock_info)) {
                                                               echo $return_stock_info->adjustment;
                                                           } else {
                                                               echo 0;
