...
if (!empty($created) || !empty($edited)) {
    ?>
    <form method="post"
          action="<?= base_url('admin/departments/saved_departments') ?>"
    ...
    <script type="text/javascript">
        $('#myModal_extra_lg').on('loaded.bs.modal', function () {
            ...
            $(document).on("submit", "form", function (event) {
                ...
                if (form.attr('action') == '<?= base_url('admin/departments/saved_departments')?>') {
                    ...
                    $.ajax({
                        ...
                        if (response.status == 'success') {
                            if (typeof (response.id) != 'undefined') {
                                var groups = $('select[name="designations_id"]');
                                groups.prepend('<option selected value="' + response.id + '">' + response.designations + '</option>');
