...
<div class="nav-tabs-custom">
    ...
    <ul class="nav nav-tabs">
        <li class="<?= $active == 1 ? 'active' : ''; ?>"><a href="#manage" data-toggle="tab"><?= lang('all_items') ?></a></li>
        <li class="<?= $active == 2 ? 'active' : ''; ?>"><a href="#create" data-toggle="tab"><?= lang('new_items') ?></a></li>
        <li class="<?= $active == 3 ? 'active' : ''; ?>"><a href="#group" data-toggle="tab"><?= lang('group') . ' ' . lang('list') ?></a> </li>
    </ul>
        ...
        <div class="tab-pane <?= $active == 1 ? 'active' : ''; ?>" id="manage">
            ...
            <div class="tab-pane <?= $active == 2 ? 'active' : ''; ?>" id="create">
                <form role="form" data-parsley-validate="" novalidate="" enctype="multipart/form-data" id="form"
                    ...
                    <div class="form-group">
                        <label class="col-lg-3 control-label"><?= lang('item_code') ?> <span
                                class="text-danger">*</span></label>
                        <div class="col-lg-5">
                            <input type="text" class="form-control" value="<?php
                            if (!empty($items_info)) {
                                echo $items_info->item_code;
                            }
                    ...
                    <div class="form-group">
                        ...
                        <div class="color-palet col-sm-8">
                            <span style="background-color:#ffffff" class="color-tag clickable active" data-color="#ffffff"></span>
                            <span style="background-color:#34495e" class="color-tag clickable " data-color="#34495e"></span>
                            <span style="background-color:#83c340" class="color-tag clickable " data-color="#83c340"></span>
                            ...
                            <input id="color" type="hidden" name="item_color" value="#ffffff">
                        </div>
                    </div>
                  <script type="text/javascript">
                  $(document).ready(function () {
