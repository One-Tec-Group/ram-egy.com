    ...
    <div class="col-sm-5">
        <div class="panel panel-custom">
            ...
            <div class="panel-body">
                <?php echo form_open(base_url('admin/purchase/update_payemnt/' . $payments_id), array('class' => 'form-horizontal', 'enctype' => 'multipart/form-data', 'data-parsley-validate' => '', 'role' => 'form')); ?>
                                    ...
                                    <div style="margin-top:50px">
                                        ...
                                        <table style="width:100%;margin-bottom:35px;table-layout:fixed;" cellpadding="0"
                                            ...
                                            <tr style="border-bottom:1px solid #ededed">
                                                ...
                                                <td style="padding: 10px 10px 5px 10px;text-align:right;word-wrap: break-word;"
                                                    valign="top">
                                                    <span><?= display_money($this->purchase_model->calculate_to('total', $purchase_info->purchase_id), $currency->symbol); ?></span>
                                                </td>
