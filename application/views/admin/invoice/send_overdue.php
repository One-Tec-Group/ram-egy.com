<div class="row">
                            ...
                            if (!empty($all_invoices_info)) {
                                foreach ($all_invoices_info as $v_invoices) {
                                    ...
                                    ?>">
                                        ...
                                        ?>
                                        <a href="<?= base_url() ?>admin/invoice/manage_invoice/send_overdue/<?= $v_invoices->invoices_id ?>">
                                            <?= $client_name ?>
    ...
    <section class="col-sm-9">
        <div class="panel panel-custom">
            <div class="panel-heading"><?= lang('send_invoice_overdue') ?></div>
            <div class="panel-body">
                <form class="form-horizontal" method="post"
                    ...
                    <input type="hidden" name="due_date" value="<?= $invoice_info->due_date; ?>">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-7">
                            <?php
                            $email_template = $this->invoice_model->check_by(array('email_group' => 'invoice_overdue_email'), 'tbl_email_templates');
