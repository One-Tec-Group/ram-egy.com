...
<table id="details" class="clearfix">
  <tr>
      <td style="width: 50%;overflow: hidden;padding:12px; background:#515151;">
...
<table class="items">
    ...
    <tr>
        <th style="padding:5px; background:#515151;color: #ffffff;"><?= $language_info['items'] ?></th>
        <?php
        $colspan = 3;
        ...
        if (!empty($invoice_view) && $invoice_view == '2') {
            $colspan = 4;
            ?>
            <th style="padding:5px; background:#515151;color: #ffffff;"><?= lang('hsn_code') ?></th>
        <?php } ?>
        <th style="padding:5px; background:#515151;color: #ffffff;"><?= $language_info['qty'] ?></th>
        <th style="padding:5px; background:#515151;color: #ffffff;"><?= $language_info['price'] ?></th>
        <th style="padding:5px; background:#515151;color: #ffffff;"><?= $language_info['tax'] ?></th>
        <th style="padding:5px; background:#515151;color: #ffffff;"><?= $language_info['total'] ?></th>
    </tr>
    </thead>
    <tbody>
    <?php
    ...
    <?php if ($proposals_info->decrease > 0): ?>
        <tr class="total">
            <td colspan="<?= $colspan ?>"></td>
            <td colspan="1"><?= $language_info['decrease'] ?></td>
            <td><?= display_money($proposals_info->decrease); ?></td>
        </tr>
      ...
      <!--   <tr style="background-color:#b5b5b5;">
       ...
       <tr >
         ...
         <tr >
          ...
          <tr  >
          <td colspan="4"  ><span >If you have any inquiry concerning this proposal, please  send an email to: <font class="font5">amr@ram-egy.com</font></span></td>
         </tr>
