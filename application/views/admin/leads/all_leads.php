                ...
                <form role="form" enctype="multipart/form-data" data-parsley-validate="" novalidate=""
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-lg-2 control-label"><?= lang('contact_name') ?>
                        ...
                        <div class="form-group">
                            <label class="col-lg-2 control-label"><?= lang('email') ?>
                              <!-- <span class="text-danger">*</span> -->
                            ...
                            <label class="col-lg-2 control-label"><?= lang('phone') ?>
                              <!-- <span class="text-danger"> *</span> -->
                        ...
                        <!-- End discount Fields -->
                        <div class="form-group">
                            <label class="col-lg-2 control-label"><?= lang('mobile') ?>
                              <!-- <span class="text-danger">*</span> -->
                            </label>
                            <div class="col-lg-4">
                                <input type="text" min="0" class="form-control" value="<?php
                                if (!empty($leads_info)) {
