...
if (file_exists(APPPATH . 'config/install.php')) {
    echo '<h1>Please Click here to <a href="' . guess_base_url() . 'install' . '">install</a></h1><p>if not works please enter /install after your URL</p>';
    exit();
}
/*
|--------------------------------------------------------------------------
