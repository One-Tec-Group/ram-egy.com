...
The " . config_item('company_name') . " Team </p > ";
    ...
    public function attach_pdf($id)
    {
        ...
        $result = pdf_create($html, slug_it(lang('purchase') . '_' . $data['purchase_info']->reference_no), 1, null, true);
        return $result;
    }
    ...
    public function payments_pdf($id)
    {
        ...
        pdf_create($viewfile, slug_it(lang('purchase') . ' ' . lang('payment') . '# ' . $data['payments_info']->trans_id));
    }
    ...
    public function pdf_purchase($id)
    {
        ...
        pdf_create($viewfile, slug_it(lang('purchase') . '# ' . $data['purchase_info']->reference_no));
    }
