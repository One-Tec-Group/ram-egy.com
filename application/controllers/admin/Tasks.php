                ...
                if ($id == 'not_started' || $id == 'in_progress' || $id == 'completed' || $id == 'deferred' || $id == 'waiting_for_someone') {
                    ...
                    if ($id == 'project') {
                        ...
                        if ($project_info->permission == 'all') {
                            $data['assign_user'] = $this->tasks_model->allowad_user('57');
                        } else {
                            $data['assign_user'] = $this->tasks_model->permitted_allowad_user($project_info->permission);
                        }
                        ...
                        if ($option_info->permission == 'all') {
                            $data['assign_user'] = $this->tasks_model->allowad_user('56');
                        } else {
                            $data['assign_user'] = $this->tasks_model->permitted_allowad_user($option_info->permission);
                        }
                    } elseif ($id == 'leads') {
                        $data['leads_id'] = $opt_id;
                        $option_info = get_row('tbl_leads', array('leads_id' => $opt_id));
                        if ($option_info->permission == 'all') {
                            $data['assign_user'] = $this->tasks_model->allowad_user('55');
                        } else {
                            $data['assign_user'] = $this->tasks_model->permitted_allowad_user($option_info->permission);
                        }
                    } elseif ($id == 'bugs') {
                        ...
                        if ($option_info->permission == 'all') {
                            $data['assign_user'] = $this->tasks_model->allowad_user('58');
                        } else {
                            $data['assign_user'] = $this->tasks_model->permitted_allowad_user($option_info->permission);
                        }
                    } elseif ($id == 'goal') {
                        ...
                        if ($option_info->permission == 'all') {
                            $data['assign_user'] = $this->tasks_model->allowad_user('69');
                        } else {
                            $data['assign_user'] = $this->tasks_model->permitted_allowad_user($option_info->permission);
                        }
                    } elseif ($id == 'sub_tasks') {
    ...
    function delete_task($id)
    {
        ...
        if (!empty($can_delete)) {
            ...
            if (empty($sub_task_info)) {
                ...
                echo json_encode(array("status" => 'error', 'message' => lang('you_cant_delete', $task_info->task_name)));
                exit();
            }
        } else {
