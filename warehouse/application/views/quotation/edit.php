            ...
            <div class="box">
              <div class="box-header with-border general">
                <h3 class="box-title"><?php echo "Reference No : ".$data[0]->reference_no; ?>
                  <input type="hidden" name="reference_no" value="<?php echo $data[0]->reference_no; ?>"
                </h3>
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                      <div class="form-group">
                        ...
                        <select class="form-control select2" id="customer" name="customer" style="width: 100%;" disabled>
                          <option value=""><?php echo $this->lang->line('product_select'); ?></option>
                          <?php
