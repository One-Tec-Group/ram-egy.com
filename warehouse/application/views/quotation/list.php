      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-sm btn-info pull-right" href="<?php echo base_url('quotation/add');?>">Add New Quotation</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                      ...
                      <td>
                          <div class="dropdown">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                              ...
                              <li>
                                <a href="<?php echo base_url('quotation/email/'); ?><?php echo $id; ?>"><i class="fa fa-envelope"></i><?php echo "Email Quotation"; ?></a>
                              </li>
                              <li>
