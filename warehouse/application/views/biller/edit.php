              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" id="warehouse" name="warehouse" style="width: 100%;">
                      ...
                      ?>
                        <option value="<?php echo $value->warehouse_id ?>" <?php if($value->warehouse_id == $biller[0]->warehouse_id) echo 'selected';?>><?php echo $value->warehouse_name." (".$value->branch_name.")"; ?></option>
                      <?php
                        }
                      ?>
                    </select>
                ...
                <div class="col-sm-6">                  
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="zipcode" name="zipcode" value="<?php echo $biller[0]->zipcode;  ?>">
