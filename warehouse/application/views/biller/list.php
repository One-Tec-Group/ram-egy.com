...
<script type="text/javascript">
  ...
  function delete_customer(id)
  {
     if(confirm('Sure To Remove This Record ?'))
     {
        window.location.href='<?php  echo base_url('customer/delete/'); ?>'+id;
     }
  }
  $(function() {
        ...
        <div class="tab-content">
                ...
                <div class="box-body">
                  <table id="example" class="table table-bordered table-striped">
                    ...
                    <tr>
                      ...
                      <th><!-- Warehouse -->
                          <?php echo $this->lang->line('biller_lable_warehouse'); ?>
                      </th>
                      <th><!-- Actions -->
                        ...
                        <?php 
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <a href="javascript:delete_customer(<?php echo $id;?>)" title="Delete" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
                            </td>
                          <?php
                            }
                          ?>
                  ...
                  <?php 
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="javascript:delete_supplier(<?php echo $id;?>)" title="Delete" class="btn btn-xs btn-danger"><span class="glyphicon glyphicon-trash"></span></a>
                      </td>
                    <?php
                      }
                    ?>
          ...
          <div class="tab-pane" id="accountant">
            <div class="col-md-12">
              <div class="box no-border">
                  <div class="box-header with-border">                  
                    <a class="btn btn-sm btn-info pull-right" style="margin: 10px" href="<?php echo base_url('accountant/add');?>" title="PDF"> <!-- Add New Biller --> 
                       Add New Accountant
                    </a>
                  </div>
                  <!-- /.box-header -->
              <div class="box-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo ($user->active) ? anchor("auth/deactivate/".$user->id, lang('index_active_link')) : anchor("auth/activate/". $user->id, lang('index_inactive_link'));?></td>
                    <td><?php echo anchor("accountant/edit/".$user->id, 'Edit') ;?></td>
                  </tr>
                <?php } endforeach;?>
                <tfoot>
                <tr>
          ...
          <div class="tab-pane" id="purchaser">
            <div class="col-md-12">
              <div class="box no-border">
                  <div class="box-header with-border">                  
                    <a class="btn btn-sm btn-info pull-right" style="margin: 10px" href="<?php echo base_url('purchaser/add');?>" title="PDF"> <!-- Add New Purchaser --> 
                        Add New Purchaser
                    </a>
                  </div>
                  <!-- /.box-header -->
              <div class="box-body">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo ($user->active) ? anchor("auth/deactivate/".$user->id, lang('index_active_link')) : anchor("auth/activate/". $user->id, lang('index_inactive_link'));?></td>
                    <td><?php echo anchor("purchaser/edit/".$user->id, 'Edit') ;?></td>
                  </tr>
                <?php } endforeach;?>
                <tfoot>
                <tr>
