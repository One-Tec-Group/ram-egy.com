              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="gstid" name="gstid" value="">
                  ...
                  <div class="form-group">
                    ...
                    <a class="pull-right" href="<?php echo base_url('warehouse/add') ?>">+ Add Warehouse</a>
                    <select class="form-control select2" id="warehouse" name="warehouse" style="width: 100%;">
                      ...
                      ?>
                        <option value="<?php echo $value->warehouse_id ?>"><?php echo $value->warehouse_name." ".$value->branch_name; ?><?php if($value->primary_warehouse == 1){ echo " (Primary)";} ?></option>
                      <?php
                        }
                      ?>
                    </select>
                  ...
                  <div class="form-group">
                    ...
                    <span class="validation-color" id="password"><?php echo form_error('password'); ?></span>
                  </div>
                  <div class="form-group">
                    ...
                    <span class="validation-color" id="password_confirm"><?php echo form_error('password_confirm'); ?></span>
                  </div>
                </div>
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" class="form-control" id="state_code" name="state_code" value="<?php echo set_value('state_code'); ?>">
                  ...
                  <div class="form-group">
                    <label for="zipcode"><!-- Fax --> 
                        <?php echo "Zipcode";?>
                    </label>
                    <input type="text" class="form-control" id="zipcode" name="zipcode" value="<?php echo set_value('zipcode'); ?>">
                    <span class="validation-color" id="err_zipcode"><?php echo form_error('zipcode'); ?></span>
                  </div>
                  ...
                  <div class="form-group">
                    <label for="mobile"><!-- Mobile --> 
                        ...
                        <span class="validation-color">*</span>
                    </label><span class="pull-right" style="font-size: 11px;">(Number should be 10 digit. Eg: 9510131490)</span>
...
//branch name validation complite.
        /*if(gstin == "" || gstin == null){
          $('#err_gstin').text("Please Enter GSTIN");
          return false;
        }
        else{
...
//GSTIN
        ...
        if(warehouse==""){
          $("#err_warehouse").text("Select the warehouse.");
          return false;
        }
        else{
          $("#err_branch_id").text("");
...
//Telephone validation complite.
        ...
        //   $('#err_mobile').text(" Please Enter Valid Mobile. ( Ex. 9876543210) ");   
        //   return false;
        // }
        // else{
        //   $("#err_mobile").text("");
