    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('income_expense_category'); ?>">Income Expense Category<a/></li>
          <li class="active">New Income Expense Category</li>
        </ol>
      </h5>    
    </section>
      ...
      <!-- right column -->
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('income_expense_category/add');?>">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="control-label require" for="inputEmail3">
                      Type
                          ...
                          <select class="form-control valdation_select" name="type" value="<?php echo set_value('type'); ?>" tabindex="2" onblur='chkDrop("Form","type","Please Select");'>
                              <option value="">
                                  Select    
                              </option>
