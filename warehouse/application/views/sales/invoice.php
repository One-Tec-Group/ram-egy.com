            ...
            <div class="box-body">
              <table id="index" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <th>Customer Name</th>
                  <th><?php echo $this->lang->line('sales_sales_amount').'('.$this->session->userdata('symbol').')'; ?></th>
                  <th><?php echo $this->lang->line('sales_paid_amount').'('.$this->session->userdata('symbol').')'; ?></th>
