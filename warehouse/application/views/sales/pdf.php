	...
	<table width="670px" border="1" cellspacing="0" style="border: 0px solid black; border-collapse: collapse;" class="table" cellpadding="2">
		...
		<tr>
			...
			<tr>
				...
				<td class="fontS" colspan="2" width="200px"><?php echo $value->name.'<br/>HSN : '.$value->hsn_sac_code;; ?></td>
				...
				?>
				<td align="right" class="fontS" colspan="2"><?php echo $value->discount_value."(".$value->discount."%)";?></td>
