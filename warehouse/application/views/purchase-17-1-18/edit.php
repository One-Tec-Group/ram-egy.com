            ...
            <div class="box-body general-data" style="">
              <div class="col-sm-12">
                <div class="row">
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                          <label for="warehouse">Warehouse<span class="validation-color">*</span></label><a href="" data-toggle="modal" data-target="#warehouse_model" class="pull-right">+</a>
                  ...
                  <div class="col-sm-3">
                    <div class="form-group">
                          <label for="supplier">Supplier<span class="validation-color">*</span></label><a href="" data-toggle="modal" data-target="#supplier_model" class="pull-right">+ </a>
              ...
              <div class="row">
                <div class="col-sm-3">
                  <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="rack_no" name="rack_no" value="<?php echo $row->rack_no; ?>">
                            ...
                            <td>
                              ...
                              <div class="form-group">
                                <select class="form-control" id="item_discount" name="item_discount" style="width: 100%;">
                                  <option value="null"><?php echo $this->lang->line('product_select'); ?></option>
    ...
    function add_row(data){
      ...
      $("table.product_table").find('input[name^="product_id"]').each(function () {
            ...
            if(flag == 0){
              ...
              select_discount += '<option value="null">Select</option>';
