    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li class="active"><?php echo $this->lang->line('header_edit_piece'); ?></li>
        </ol>
      </h5>
    </section>
    <!-- Main content -->
      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $this->lang->line('header_edit_piece'); ?></h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('pieces/editPiece');?>" encType="multipart/form-data">
                 <?php foreach($data as $row){?>
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="hidden" name="id" value="<?php echo $row->piece_id;?>">
                    ...
                    <div class="form-group">
                      <label for="unit"><?php echo $this->lang->line('pieces_piece_unit'); ?> <span class="validation-color">*</span></label>
                    ...
                    <div class="form-group">
                      <label for="size"><?php echo $this->lang->line('pieces_piece_cost'); ?>  </label>
