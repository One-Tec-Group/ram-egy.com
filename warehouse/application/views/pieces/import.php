      ...
      <div class="col-md-12">
        ...
        <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-lg-12">
                  <form action="<?php echo base_url('pieces/import_csv'); ?>" class="form-horizontal" data-toggle="validator" role="form" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                        ...
                        <div class="col-md-6">
                          <div class="form-group">
                            ...
                            <input type="file" data-browse-label="Browse ..." name="csv" class="form-control file" data-show-upload="false" data-show-preview="false" id="csv" required="required" accept=".csv"/>
                                ...
                                <input type="hidden" name="update_records" value="yes">
                        </div>
                        <div class="col-md-12">
