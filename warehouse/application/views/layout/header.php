...
<head>
  ...
  <title>RAM Warehouse | <?= (($this->uri->segment(1) == "auth") ? strtoupper(str_replace("_", " ", $this->uri->segment(2))) : strtoupper(str_replace("_", " ", $this->uri->segment(1)))); ?></title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="#" class="logo">
      ...
      <span class="logo-lg"><span style="font-size: 24px;">RAM</span><span style="font-size: 24px;"> Warehouse</span></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li>
            <a href="<?php echo base_url('product_alert');?>" >
              <?= $this->lang->line("header_product_alert"); ?>
          ...
          ?>
          <li>
            <a href="<?php echo base_url('pieces_alert');?>" >
              <?= $this->lang->line("header_pieces_alert"); ?>
              <span class="label text-red" style="background-color: white;">
                <?php
                  echo $data = $this->db->select('count(*) as count')
                                        ->from('pieces p1')
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <?php
          if($this->session->userdata('type')=="admin" || $this->session->userdata('type')=="purchaser" ){
        ?>
        <!-- <li class="treeview <?php if($this->uri->segment(1)=='credit_debit_note' || $this->uri->segment(1)=='gst_return'){ echo 'active'; } ?>">
          <a href="#">
        ...
        <li class="treeview <?php if($this->uri->segment(1)=='cash_flow' || $this->uri->segment(1)=='statement' || $this->uri->segment(1)=='payment' || $this->uri->segment(1)=='receipt' || $this->uri->segment(1)=='expense'){ echo 'active'; } ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="treeview <?php if($this->uri->segment(1)=='cash_flow'){ echo 'active'; } ?>">
              <a href="<?php echo base_url('cash_flow');?>">
                <i class="fa fa-file-o text-green"></i>
                <span>Cash Flow</span>
              </a>
            </li>
            <li class="treeview <?php if($this->uri->segment(1)=='statement'){ echo 'active'; } ?>">
            ...
            <li class="treeview <?php if($this->uri->segment(1)=='payment' || $this->uri->segment(1)=='receipt'){ echo 'active'; } ?>">
              ...
              <ul class="treeview-menu">
                <li class="treeview <?php if($this->uri->segment(1)=='payment'){ echo 'active'; } ?>">
                  <a href="<?php echo base_url('payment');?>">
                    <i class="fa fa-money text-maroon"></i>
                    <span><?php echo $this->lang->line('header_payment'); ?></span>
                  </a>
                </li>
                <li class="treeview <?php if($this->uri->segment(1)=='receipt'){ echo 'active'; } ?>">
        ...
        ?>
        <li class="treeview <?php if($this->uri->segment(1)=='pieces' || $this->uri->segment(1)=='product' || $this->uri->segment(1)=='transfer'){ echo 'active'; } ?>">
          <a href="#">
          ...
          <ul class="treeview-menu">
            <li class="treeview <?php if($this->uri->segment(1)=='pieces'){ echo 'active'; } ?>">
              <a href="<?php echo base_url('pieces');?>">
                <i class="fa fa-cube text-blue"></i>
                <span><?php echo $this->lang->line('header_pieces') ?></span>
              </a>
            </li>
            ...
            <?php if($this->session->userdata('type')!="purchaser") { ?>
            <li class="treeview <?php if($this->uri->segment(1)=='transfer'){ echo 'active'; } ?>">
    ...
    <?php if($this->session->userdata('type')=="admin"){ ?>
        ...
        <li class="treeview <?php if($this->uri->segment(1)=='pieces_warehouse' || $this->uri->segment(1)=='company_setting' || $this->uri->segment(1)=='category' || $this->uri->segment(1)=='subcategory' || $this->uri->segment(1)=='branch' || $this->uri->segment(1)=='brand' || $this->uri->segment(1)=='discount' || $this->uri->segment(1)=='uqc' || $this->uri->segment(1)=='warehouse' || $this->uri->segment(1)=='assign_warehouse' || $this->uri->segment(1)=='email_setup'){ echo 'active'; } ?>">
          ...
          <ul class="treeview-menu">
            ...
            <li class="treeview">
              <a href="<?php echo base_url("pieces_warehouse");?>">
                <i class="fa fa-university text-suffron"></i>
                <span><?php echo $this->lang->line('header_pieces_warehouse'); ?></span>
              </a>
            </li>
            <!--
            <li class="treeview">
