  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b><?php echo $this->lang->line('dashboard_version'); ?></b> 3.0
    </div>
    <strong>&copy; <a href="" target="_blank">One Tec Group L.L.C.</a></strong> All <?php echo $this->lang->line('dashboard_rights_reserved'); ?>
  </footer>
<!-- ./wrapper -->
<!-- Control Sidebar -->
