                      ...
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <?php  }
                            ...
                            <select class="form-control select2" id="user_id" name="user_id" style="width: 100%;" disabled="disabled">
                              <option value=""><?php echo $this->lang->line('product_select'); ?></option>
                            <?php                           
                              foreach ($warehouse as $row) {
                            ?>
                              <option value="<?php echo $row->user_id; ?>" <?php if($row->warehouse_id==$data[0]->warehouse_id) echo "selected disabled"; ?>><?php echo $row->warehouse_name;?></option>
                            <?php
                              }
                            ?> 
                          </select>
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        <div class="form-group">
                          ...
                          <input type="hidden" id="shipping_state_id" name="shipping_state_id" value="<?php echo $shipping_state_id; ?>">
                          <input type="hidden" id="customer" name="customer" value="<?php echo $data[0]->customer_id; ?>">
