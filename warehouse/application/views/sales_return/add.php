                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <?php  }
                          ...
                          ?>
                              <option value='<?php echo $row->user_id; ?>'><?php echo $row->warehouse_name."-".$row->branch_name; if($row->primary_warehouse ==1 ) echo '(Primary)'?></option>
    ...
    function add_row(data){
      ...
      $("table.product_table").find('input[name^="product_id"]').each(function () {
            ...
            if(flag == 0){
              ...
              var shipping_state_id = $("#customer_state_id").val();
