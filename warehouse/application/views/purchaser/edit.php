    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('biller'); ?>">People</a>
          </li>
          <li class="active">Edit Purchaser</li>
        </ol>
      </h5>    
    </section>
<!-- Main content -->
        ...
        <div class="col-sm-12">
          ...
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Purchaser
              </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                ...
                <form role="form" id="form" method="post" action="<?php echo base_url('purchaser/editPurchaser');?>">
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="firstname" id="firstname" class="form-control" value="<?php echo $user->first_name;  ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="lastname" id="lastname" class="form-control" value="<?php echo $user->last_name;  ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="company" id="company" class="form-control" value="<?php echo $user->company;  ?>">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="phone">
                      ...
                      <input type="phone" name="phone" id="phone" class="form-control" value="<?php echo $user->phone;  ?>">
                  ...
                  <div class="form-group">
                    ...
                    <select class="form-control select2" id="warehouse_id" name="warehouse_id" style="width: 100%;">
                      ...
                      ?>
                        <option value="<?php echo $value->warehouse_id ?>" <?php if($value->warehouse_id == $user_warehouse[0]->warehouse_id) echo 'selected';?>><?php echo $value->warehouse_name." ".$value->branch_name." "; ?><?php if($value->primary_warehouse == 1){ echo " (Primary)";} ?></option>
                      <?php
                          }
                ...
                <div class="col-sm-12">
                  <div class="box-footer">
                    <button type="submit" id="submit" class="btn btn-info">&nbsp;&nbsp;&nbsp;<!-- Add -->
                        <?php //echo $this->lang->line('add_user_btn');?>Update
                    &nbsp;&nbsp;&nbsp;</button>
