    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('biller'); ?>">Accountant</a>
          </li>
        ...
        <div class="col-sm-12">
          <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title">Edit Accountant
              </h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="row">
                ...
                <form role="form" id="form" method="post" action="<?php echo base_url('accountant/editAccountant');?>">
                <div class="col-sm-6">
                  <div class="form-group">
                    <label for="firstname">First Name</label>
                    <input type="text" name="firstname" id="firstname" class="form-control" value="<?php echo $user->
                    first_name; ?>">
                    <input type="hidden" name="user_id" id="user_id" class="form-control" value="<?php echo $user->
                    user_id; ?>">
                ...
                <div class="col-sm-6">
                  <div class="form-group">
                    ...
                    <input type="phone" name="mobile" id="mobile" class="form-control" value="<?php echo $user->phone; ?>">
