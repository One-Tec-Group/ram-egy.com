                ...
                <form role="form" id="form" method="post" action="<?php echo base_url('company_setting/add');?>" encType="multipart/form-data">
                  <div class="col-md-6">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="gstin" name="gstin" value="<?php if(isset($data[0]->gstin)){ echo $data[0]->gstin; }?>" autocomplite="off">
                  ...
                  <div class="form-group">
                    ...
                    <label for="country">Favico Icon</span></label>
                    <input type="file" id="favico" name="favico">
                      <?php if(isset($data[0]->favico)){?>
                      <img src="<?php echo base_url().$data[0]->favico;?>" width="20%">
                      <?php }?>
                      <input type="hidden" name="hidden_favico" value="<?php if(isset($data[0]->favico)){echo $data[0]->favico;}?>">
                      <span class="validation-color" id="err_logo"><?php echo form_error('favico'); ?></span>
                  </div>
                  <div class="form-group">
                      <label for="gstregtype">Theme
                        <span class="validation-color">*</span>
                      </label>
                      <select class="form-control select2" id="theme" name="theme" style="width: 100%;">
                        
                        <option value="skin-blue" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-blue"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Blue
                        </option>
                        <option value="skin-blue-light" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-blue-light"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Light Blue
                        </option>
                        <option value="skin-yellow" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-yellow"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Yellow
                        </option>
                        <option value="skin-yellow-light" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-yellow-light"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Light Yellow
                        </option>
                        <option value="skin-green" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-green"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Green
                        </option>
                        <option value="skin-green-light" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-green-light"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Light Green
                        </option>
                        <option value="skin-purple" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-purple"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Purple
                        </option>
                        <option value="skin-purple-light" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-purple-light"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Light Purple
                        </option>
                        <option value="skin-red" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-red"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Red
                        </option>
                        <option value="skin-red-light" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-red-light"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Light Red
                        </option>
                        <option value="skin-black" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-black"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Black
                        </option>
                        <option value="skin-black-light" <?php 
                                  if(isset($data[0]->theme)){
                                    if($data[0]->theme == "skin-black-light"){
                                      echo "selected";
                                    }
                                  } 
                                ?>>Light Black
                ...
                <div class="col-sm-6">
                    ...
                    <div class="form-group">
                  	...
                  	<div class="form-group">
                    	...
                    	<!-- /.form-group -->
                  	<div class="form-group">
                    	<label for="language"><?php echo $this->lang->line('company_setting_default_language'); ?> </label>
                  	...
                  	<!-- /.form-group -->
                  	<div class="form-group">
                    	<label for="currency"><?php echo $this->lang->line('company_setting_default_currency'); ?> </label>
...
<script>
    $('#state').change(function(){
      ...
      //       if(gstin_state_code!=data){
      //         $('#err_gstin').text("Please Enter Valid GSTIN.Your GSTIN and State does not match.");
      //       }
      //       else{
      //         $('#err_gstin').text('');
      //       }
...
//site short name validation complite.
      ...
      //   if(gstin == "" || gstin == null){
      //     $('#err_gstin').text(gstin_empty);
      //     return false;
      //   }
      //   else{
      //     if(gstin_state_code!=state_code){
      //       $('#err_gstin').text(gstin_not_match);
      //       return false;
      //     }
      //     else{
      //       $('#err_gstin').text("");
