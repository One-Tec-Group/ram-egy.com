            ...
            <div class="row hide1">
              <form target="" id="edit-profile" method="post" action="<?php echo base_url('reports/sales_report');?>">
                <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label for="customer"><?php echo $this->lang->line('sales_select_customer'); ?></label>
                    <select class="form-control select2" id="customer" name="customer" style="width: 100%;">
                      <option value=""><?php echo $this->lang->line('product_select'); ?></option>
                      <?php

                        foreach ($customer as $row) {
                          echo "<option value='$row->customer_id'".set_select('customer_id',$row->customer_id).">$row->customer_name</option>";
                        }
                      ?>
                    </select>
