    ...
    <section class="content-header">
      <h5>
         <ol class="breadcrumb">
          ...
          <li class="active"><?php echo $this->lang->line('reports_purchase_reports'); ?></li>
        </ol>
      </h5> 
    </section>
    <!-- Main content -->
    <section class="content">
      ...
      <div class="col-md-12">
        <div class="box">
          ...
          <div class="box-body">
            <div class="row hide1">
              <form target="" id="edit-profile" method="post" action="<?php echo base_url('reports/purchase_report');?>">
                <div class="col-md-6">
      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $this->lang->line('reports_purchase_reports'); ?></h3>
                ...
                <tbody>
                  <?php 
                    ...
                    <tr>
                      ...
                      <td><a href="<?php echo base_url('purchase/view/').$row->purchase_id; ?>"><?php echo $row->reference_no; ?></a></td>
