    ...
    <section class="content">
      <div class="row">
      	<div class="col-md-12">
              ...
              <?php echo $this->lang->line('reports_current_month_sales'); ?> <?php echo $current_month_sales; ?> 
            </span>
  					<span class="external-event bg-green pull-right">
              <?php echo $this->lang->line('reports_profite'); ?> <?php  echo $profit; ?>   
            </span>
  				</div>
  				</div>
      		</div>
