              ...
              <div class="row">
                      ...
                      <tbody id="product_table_body">
                       ...
                       // $product_data = [];
                        ...
                        <tr>
                            ...
                            <td><input type="checkbox" id="tax_type" name="tax_type" value="Inclusive"></td>
                            <td align="right">
                ...
                <div class="col-sm-12">
                  <div class="box-footer">
                    ...
                    <span class="btn btn-default" id="cancel" style="margin-left: 2%" onclick="cancel('bank_account')"><?php echo $this->lang->line('product_cancel'); ?></span>
                  </div>
                </div>
                <?php } ?>
              </form>
