                    ...
                    <div class="row">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control select2" id="biller" name="biller" style="width: 100%;">
                          ...
                          <?php  
                            foreach ($biller as $tts) {
                              //echo "<option value='$tts->biller_id'>$tts->biller_name</option>";
                              ?>
                                          <option value='<?php echo $tts->biller_id ?>' <?php if($tts->biller_id == $row->biller_id){echo "selected";} ?>><?php echo $tts->biller_name ?></option>
                                  <?php
                            }
                          ?> 
                        </select>                        
