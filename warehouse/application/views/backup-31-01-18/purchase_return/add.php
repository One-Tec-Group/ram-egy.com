                ...
                <div class="col-sm-6">
                  <div class="well">
                    <div class="row">
                      <div class="col-sm-6">
                      <div class="form-group">
                        <label for="biller"><?php echo $this->lang->line('sales_select_biller'); ?> <span class="validation-color">*</span></label><!--<a href="" data-toggle="modal" data-target="#assignWarehouse" class="pull-right">+ Assign Warehouse</a>-->
                        ...
                        ?>
                            <option value='<?php echo $row->warehouse_id; ?>' <?php if($row->primary_warehouse==1) echo "selected"; ?>><?php echo $row->warehouse_name." - ".$row->branch_name; ?></option>
                        <?php 
                          }
                        ?> 
                      </select>                      
                        <input type="hidden" name="warehouse_state_id" id="warehouse_state_id">
