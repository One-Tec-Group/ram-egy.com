              ...
              <div class="col-sm-12">
                <div class="row">
                  ...
                  <div class="col-sm-3">
                      ...
                      <div class="form-group">
                        <label for="warehouse"><?php echo $this->lang->line('purchase_select_warehouse'); ?> <span class="validation-color">*</span>
                        </label>
                        <a href="#" title="Admin will be able to purchase products into primary warehouse" class="pull-right"><img src="<?php echo base_url('assets/images').'/info.png' ?>"/></a>

                        <select class="form-control select2" id="warehouse" name="warehouse" style="width: 100%;">
                          <option value=""><?php echo $this->lang->line('product_select'); ?></option>
                          <?php  
                            foreach ($warehouse as $row) {
                              echo "<option value='$row->warehouse_id'". if($row->primary_warehouse==1){ echo "selected";} .">$row->warehouse_name</option>";
                            }
                          ?> 
                        </select>                        
                        <input type="hidden" name="biller_state_id" id="biller_state_id">
