      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-sm btn-info pull-right" style="margin: 10px" href="<?php echo base_url('assign_warehouse/add');?>" title="Add New Category" onclick=""><?php echo $this->lang->line('assign_warehouse'); ?></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
