      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-sm btn-info pull-right" style="margin: 10px" href="<?php echo base_url('category/add');?>" title="Add New Category" onclick=""><!-- Add New Category --> <?php echo $this->lang->line('category_lable_newcategory'); ?></a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
