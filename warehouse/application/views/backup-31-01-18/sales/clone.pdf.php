		            ...
		            <div class="box-body">
		            	...
		            	<div class="col-sm-12">
		            		<table width="100%">
			            		...
			            		<tr>
			            			<td style="font-size: 18px;padding: 10px 10px 10px 0px;"><?php echo $data[0]->customer_name; ?></td>
			            		...
			            		<tr>
			            			<td><?php echo $data[0]->customer_city; ?></td>
			            			<td><?php echo $data[0]->biller_city; ?></td>
			            		</tr>
			            		<tr>
			            			<td><?php echo $data[0]->customer_country; ?></td>
			            			<td><?php echo $data[0]->biller_country; ?></td></td>
			            		</tr>
			            		<tr>
			            			<td><?php echo "Mo : ".$data[0]->customer_mobile; ?></td>
			            			<td><?php echo "Mo : ".$data[0]->biller_mobile; ?></td>
			            		</tr>
			            		<tr>
			            			<td><?php echo "Email : ".$data[0]->customer_email; ?></td>
			            ...
			            <div class="col-sm-12">
			            	<table align="left" width="100%">
			            		<tr>
			            			...
			            			<td width="30%"></td>
			            			<td width="35%">Customer : <?php echo $data[0]->customer_name; ?></td>
			            		</tr>
			            		<tr>
