              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="shipping_charge" name="shipping_charge" value="<?php echo $row->shipping_charge;?>">
                  ...
                  <div class="form-group">
                    ...
                    <select id="sales_invoice" name="sales_invoice" class="form-control select2">
                      <option value="1" <?php if($row->sales_invoice==1){ echo 'selected';} ?>>Regular</option>
                      <option value="2" <?php if($row->sales_invoice==2){ echo 'selected';} ?>>SEZ Supplies with Payment</option>
                      <option value="3" <?php if($row->sales_invoice==3){ echo 'selected';} ?>>SEZ Supplies without Payment</option>
                      <option value="4" <?php if($row->sales_invoice==4){ echo 'selected';} ?>>Deemed Export</option>
                    </select>
                    <span class="validation-color" id="err_shipping_charge"><?php echo form_error('shipping_charge'); ?></span>
                  </div>
                  ...
                  <div class="form-group">
                    ...
                    <input type="radio" name="sales_type" id="sales_type" value="0" <?php if($row->sales_type==0){ echo 'checked';} ?>> Through E-commerce &nbsp;&nbsp;&nbsp;&nbsp;
                    <input type="radio" name="sales_type" id="sales_type" value="1" <?php if($row->sales_type==1){ echo 'checked';} ?>> Other than E-commerce 
                  </div>
                  <div class="form-group">
                    <input type="checkbox" class="" id="gst_payable" name="gst_payable" value="Y" <?php if($row->gst_payable=='Y'){ echo 'checked';} ?>>&nbsp;&nbsp;&nbsp;&nbsp;
                ...
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="supplier_ref" name="supplier_ref" value="<?php echo $row->supplier_ref; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="buyer_order" name="buyer_order" value="<?php echo $row->buyer_order; ?>" >
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="dispatch_document_no" name="dispatch_document_no" value="<?php echo $row->dispatch_document_no; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control datepicker" id="delivery_note_date" name="delivery_note_date" value="<?php echo $row->delivery_note_date; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="dispatch_through" name="dispatch_through" value="<?php echo $row->dispatch_through; ?>">
                ...
                <div class="col-sm-12">
                  <div class="form-group">
                    ...
                    <table class="table items table-striped table-bordered table-condensed table-hover product_table" name="product_data" id="product_data">
                      <thead>
                        <tr>
                          ...
                          <th class="span2"><?php echo $this->lang->line('product_price').'('.$this->session->userdata('symbol').')'; ?></th>
                          <th class="span2" width="10%"><?php echo $this->lang->line('sales_total_sales').'('.$this->session->userdata('symbol').')'; ?></th>
                          <th class="span2" width="15%"><?php echo $this->lang->line('header_discount'); ?></th>
                          <th class="span2"><?php echo $this->lang->line('purchase_taxable_value').'('.$this->session->userdata('symbol').')'; ?></th>
                          <th class="span2" width="15%"><?php echo $this->lang->line('header_tax'); ?></th>
                          <th class="span2" width="10%"><?php echo $this->lang->line('purchase_total').'('.$this->session->userdata('symbol').')'; ?>
                        </tr>
                      </thead>
                    ...
                    <table class="table table-striped table-bordered table-condensed table-hover">
                      ...
                      <tr>
                        <td align="right"><?php echo $this->lang->line('purchase_total_discount').'('.$this->session->userdata('symbol').')'; ?> </td>
                        <td align='right'><span id="totalDiscount"><?php echo $row->discount_value; ?></span>
                        </td>
                      </tr>
                      <tr>
                        <td align="right"><?php echo $this->lang->line('purchase_total_tax').'('.$this->session->userdata('symbol').')'; ?> </td>
                        <td align='right'><span id="totalTax"><?php echo $row->tax_value; ?></span>
                        </td>
                      </tr>
                      <tr>
                        <td align="right"><?php echo $this->lang->line('purchase_total').'('.$this->session->userdata('symbol').')'; ?> </td>
                        <td align='right'><span id="grandTotal"><?php echo $row->total; ?></span></td>
                      </tr>
                    </table>
                  </div>
                </div>
...
<script>
  $('input[name="search"]').change(function(){
    var search_hint = $('input[name="search"]:checked').val();
    if(search_hint=='code'){
