...
<body>
	<table width="100%" border="1" cellspacing="0" style="border: 0px solid black; border-collapse: collapse;" cellpadding="2">
			...
			?>
				<tr>
					<td colspan="13" align="right">Round Off Amount : <?php echo round($data[0]->total) - $data[0]->total; ?></td>
				</tr>
				<tr>
					<td colspan="13" align="right">Final Total Amount : <?php echo round($data[0]->total); ?></td>
				</tr>
				<tr>
					<td colspan="5" style="border-right: none;"><b style="text-align: left;">Our Bank Details -</b> </td>
					<td colspan="8" style="border-left: none;"><b style="text-align: right;">Amount In Words : <?php echo $this->numbertowords->convert_number(round($data[0]->shipping_charge+$data[0]->total-$data[0]->paid_amount-$data[0]->flat_discount)); ?> Only</b></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td style="border-left: none;" align="right" colspan="4" align="center" valign="top">
						...
						<br>For, <span style="color: red;">Maa Sulochana Offset</span>
						<br>
						<br>
