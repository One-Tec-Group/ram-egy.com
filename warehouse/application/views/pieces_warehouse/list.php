...
<script type="text/javascript">
  function delete_id(id)
  {
     ...
     {
        window.location.href='<?php  echo base_url('pieces_warehouse/delete/'); ?>'+id;
     }
  }
  setTimeout(function() {
      ...
      <div class="col-md-12">
        ...
        <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-sm btn-info pull-right" style="margin-left: 10px" href="<?php echo base_url('pieces_warehouse/add');?>" title="Add New Category" onclick="">
                  <!-- Add New Warehouse -->
            ...
            <div class="box-body">
              <table id="index" class="table table-bordered table-striped">
                ...
                <tbody>
                  <?php
                      foreach ($data as $row) {
                         $id= $row->Pwarehouse_id;
                    ?>
                    <tr>
                      <td></td>
                      <td><?php echo $row->Pwarehouse_name; ?></td>
                      <td><?php echo $row->branch_name; ?></td>
                      <td><?php if($row->primary_Pwarehouse == 1){echo "Primary";}else{ echo "Secondary";} ?></td>
                      <td><?php echo $row->first_name.' '.$row->last_name; ?></td>
                      <td>
                          <a href="<?php echo base_url('pieces_warehouse/edit/'); ?><?php echo $id; ?>" title="Edit" class="btn btn-xs btn-info"><span class="glyphicon glyphicon-edit"></span></a>&nbsp;&nbsp;
