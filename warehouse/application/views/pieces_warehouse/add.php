        ...
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <div class="col-md-6">
                <form role="form" id="form" method="post" action="<?php echo base_url('pieces_warehouse/addWarehouse');?>">
                  <div class="form-group">
                    <label for="branch"><!-- Select Branch -->
                        <?php echo $this->lang->line('add_biller_select_branch'); ?>
                      <span class="validation-color">*</span></label>
                      <span class="pull-right"><a href="<?php echo base_url('branch/add'); ?>">+ Add Branch</a></span>
                  ...
                  <div class="checkbox">
                    <label>
                      <input type="checkbox" name="primary_warehouse" <?php if($warehouse_count==0){ echo 'checked disabled';} ?>> Primary
                    </label>
                    <br/>
