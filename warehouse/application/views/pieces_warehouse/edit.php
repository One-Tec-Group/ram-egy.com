    ...
    <section class="content-header">
      <h5>
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('pieces_warehouse'); ?>"><!-- Warehouse -->
                  <?php echo $this->lang->line('header_pieces_warehouse'); ?></a></li>
    ...
    <section class="content">
      ...
      <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
              <div class="col-sm-6">
                <form role="form" id="form" method="post" action="<?php echo base_url('pieces_warehouse/editWarehouse');?>">
                  <?php foreach($data as $row){?>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="warehouse_name" name="warehouse_name" value="<?php echo $row->Pwarehouse_name; ?>">
                      <input type="hidden" name="id" value="<?php echo $row->Pwarehouse_id;?>">
