...
$(document).ready(function(){
    $('#state-supplier').change(function(){
      ...
      $.ajax({
          ...
          success: function(data){
            for(i=0;i<data.length;i++){
              $('#city-supplier').append('<option value="' + data[i].id + '">' + data[i].name + '</option>');
            }
          }
        });
      $.ajax({
...
//email validation complite.
    $.ajax({
        ...
        data:{
            ...
            'city':$('#city-supplier').val(),
            'country':$('#country-supplier').val(),
            'state':$('#state-supplier').val(),
            'mobile':$('#mobile').val(),
            'email':$('#email').val(),
            'gstid':$('#gstid').val(),
        ...
        success:function(result){
          ...
          $('#supplier_state_id').val(result['supplier_state_id']);
          //alert($('#supplier_state_id').val());
