      ...
      <h5>
        <ol class="breadcrumb">
          ...
          <li><a href="<?php echo base_url('biller'); ?>">
              <!-- Supplier -->
              <?php echo $this->lang->line('supplier_header'); ?></a>
          </li>
          <li class="active">
            <!-- Edit Supplier -->
            <?php echo $this->lang->line('edit_supplier_header'); ?>
          </li>
        </ol>
      </h5>    
    </section>
    ...
    <section class="content">
      ...
      <div class="col-md-12">
        <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('supplier/editSupplier');?>">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="state_code" name="state_code" value="<?php echo $row->state_code; ?>">
