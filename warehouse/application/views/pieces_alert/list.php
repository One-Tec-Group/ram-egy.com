    ...
    <section class="content-header">
      <h5>
         <ol class="breadcrumb">
          ...
          <li class="active"><?php echo $this->lang->line('header_pieces_alert'); ?></li>
        </ol>
      </h5>
    </section>
    <!-- Main content -->
      ...
      <div class="col-md-12">
        <div class="box">
            <div class="box-header with-border">
              <h3 class="box-title"><?php echo $this->lang->line('header_list_pieces_alert'); ?></h3>
              <a class="btn btn-sm btn-info pull-right" style="margin: 10px" href="<?php echo base_url('pieces_alert/create_pdf');?>" target="_new" title="PDF"> &nbsp;<?php echo $this->lang->line('product_alert_pdf'); ?>&nbsp; </a>
              <a class="btn btn-sm btn-info pull-right" style="margin: 10px" href="<?php echo base_url('pieces_alert/create_csv');?>" target="_new" title="PDF"> &nbsp;CSV&nbsp; </a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
