        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-sm btn-info pull-right bg-yellow" style="margin-left: 10px" href="<?php echo base_url('biller/add'); ?>" title="Add Biller" onclick="">
                  <!-- Add New Warehouse -->
                Add Biller              
              </a>
              <a class="btn btn-sm btn-info pull-right bg-green" style="margin-left: 10px" href="<?php echo base_url('purchaser/add'); ?>" title="Add Purchaser" onclick="">
                  <!-- Add New Purchaser -->
                Add Purchaser              
              </a>
            </div>
              ...
              <div class="row">
                ...
                <form role="form" id="form" method="post" action="<?php echo base_url('assign_warehouse/assignWarehouse');?>">
                  <div class="form-group">
                    ...
                    <span style="font-size: 12px;">(All Biller, Purchaser and Manager will list out here - excluding admin &amp; accountant)</span><br/>
