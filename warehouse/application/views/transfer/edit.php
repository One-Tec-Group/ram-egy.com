                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        <label for="from_warehouse"><?php echo $this->lang->line('transfer_from_warehouse'); ?><span class="validation-color">*</span></label>
                          <select class="form-control select2" name="from_warehouse" id="from_warehouse" style="width: 100%;">
                          <?php
                            foreach ($warehouse as  $key) {
                              if($key->warehouse_id == $row->from_warehouse)
                              {
                                ?>
                                  <option value='<?php echo $key->warehouse_id ?>' ><?php echo $key->warehouse_name ?></option>
                                <?php
                              } 
                            }
                          ?> 
                             ...
                             // $product_data = [];
                              ...
                              <tr>
                                ...
                                <input type="checkbox" id="tax_type" name="tax_type" value="Inclusive">
                                  ...
                                  <td><input type="text" class="form-control text-right" id="product_total" name="product_total" value=" <?php echo $key->gross_total + $key->igst_tax; ?>" readonly>
                                </td>
                              </tr>
                              <?php
...
<script>
 $(document).ready(function(){
    ...
    $("table.product_table").on("change", 'input[name^="price"], input[name^="qty"],input[name^="igst"],input[name^="tax_type"]', function (event) {
