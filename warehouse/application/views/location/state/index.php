...
<script type="text/javascript">
  function delete_id(id)
  {
     ...
     {
        window.location.href='<?php  echo base_url('location/deleteState/'); ?>'+id;
     }
  }
  $(function() {    
    setTimeout(function() {
        ...
        <div class="col-md-9">
          ...
          <div class="box">
            <div class="box-header with-border">
              ...
              <a class="btn btn-sm btn-info pull-right" style="margin-right: 10px" href="<?php echo base_url('location/addState');?>" title="Add New Category" onclick=""><!-- Add New Category --> <?php echo "Add State"; ?>
              </a>
            </div>
            <div class="box-body">
              <table id="index" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                        <a href="<?php echo base_url('location/addState/'); ?><?php echo $id; ?>" title="Edit" class="btn btn-xs btn-info"><span class="glyphicon glyphicon-edit"></span></a>
                        ...
                        <a href="<?php echo base_url('location/city/'); ?><?php echo $id; ?>" title="Edit" class="btn btn-xs btn-warning">View Cities</a>&nbsp;&nbsp;
                    </td>
                  </tr>
                  <?php
                    }
