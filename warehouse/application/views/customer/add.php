      ...
      <!-- right column -->
        <div class="col-md-12">
          <div class="box">
            ...
            <div class="box-body">
              <div class="row">
                <form role="form" id="form" method="post" action="<?php echo base_url('customer/addCustomer');?>">
                <div class="col-md-6">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="servicetaxno">Service Tax Aeg No
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="state_code" name="state_code" value="<?php echo set_value('state_code'); ?>" readonly>
                  ...
                  <div class="form-group">
                    <label for="postal_code"><!-- Postal Code -->
                        <?php echo $this->lang->line('add_customer_code'); ?><span class="validation-color">*</span>
                     </label>
