                    ...
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-2"><?=$this->lang->line('product_photo')?></th>
                                <th class="col-sm-2"><?=$this->lang->line('product_product')?></th>
                                <th class="col-sm-1"><?=$this->lang->line('product_category')?></th>
                                <th class="col-sm-1"><?=$this->lang->line('product_buyingprice')?></th>
                                <th class="col-sm-1"><?=$this->lang->line('product_sellingprice')?></th>
                        ...
                        <tbody>
                            <?php if(count($products)) {$i = 1; foreach($products as $product) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('product_photo')?>">
                                        <?= profileimage($product->photo); ?>
                                    </td>
