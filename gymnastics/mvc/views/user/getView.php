<?php if (count($profile)) { ?>
    <div class="well">
        <div class="row">
            <div class="col-sm-6">
                <?php
                if (!permissionChecker('user_view') && permissionChecker('user_add')) {
                    echo btn_sm_add('user/add', $this->lang->line('add_user'));
                }
                ?>
                ...
                if (permissionChecker('user_edit')) {
                    echo btn_sm_edit('user/edit/' . $profile->userID, $this->lang->line('edit'));
                }
                ?>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-sm-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        ...
                        <?php if ($this->session->userdata('usertypeID') == 1 && $this->session->userdata('usertype') == "Admin" && count($manage_salary) > 0) { ?>
                        ...
                        <div class="active tab-pane" id="profile">
                            <div class="panel-body profile-view-dis">
                                <div class="row">
                                    ...
                                    <h3 style="color: #dd4b39"><?= $this->lang->line("user_info") ?></h3>
                                    <hr>
                                    ...
                                    <h3 style="color: #dd4b39"><?= $this->lang->line("user_contact") ?></h3>
                                    <hr>
                                    <div class="profile-view-tab">
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><?= $this->lang->line("user_phone") ?> </span>: <?= $profile->phone ?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span></span></p>
                                    </div>

                                    <h3 style="color: #dd4b39"><?= $this->lang->line("user_account") ?></h3>
                                    <hr>
                                    ...
                                    <?php
                                    if (permissionChecker('user_edit')) {
                                        echo btn_sm_edit('user/edit/' . $profile->userID, $this->lang->line('edit_user_password'));
                                    }
                                    ?>
                        ...
                        <?php if ($this->session->userdata('usertypeID') == 1 && $this->session->userdata('usertype') == "Admin" && count($manage_salary) > 0) { ?>
                            ...
                            <div class="tab-pane" id="payment">
                                ...
                                if ($manage_salary->salary == 2) {
                                    echo $this->lang->line('user_net_salary_hourly');
                                } else {
                                    echo $this->lang->line('user_net_salary');
                                }
                                ?></th>
                                            ...
                                            <tr>
                                                <td colspan="4" data-title="<?= $this->lang->line('user_total') ?>">
                                                    ...
                                                    if ($siteinfos->currency_code) {
                                                        echo '<b>' . $this->lang->line('user_total') . ' (' . $siteinfos->currency_code . ')' . '</b>';
                                                    } else {
                                                        echo '<b>' . $this->lang->line('user_total') . '</b>';
                                                    }
                                                    ?>
                                                </td>
