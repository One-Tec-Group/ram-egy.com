                                        ...
                                        <td data-title="<?=$this->lang->line('action')?>">
                                            <?php
                                                    ...
                                                    if(permissionChecker('productsale_add')) {
                                                        if(isset($grandtotalandpaid['grandtotal'][$productsale->productsaleID]) && isset($grandtotalandpaid['totalpaid'][$productsale->productsaleID])) {
                                                            if((float)$grandtotalandpaid['grandtotal'][$productsale->productsaleID] > (float)$grandtotalandpaid['totalpaid'][$productsale->productsaleID]) {
                                                                echo '<a href="#addpayment" id="'.$productsale->productsaleID.'" class="btn btn-primary btn-large mrg getsaleinfobtn" rel="tooltip" data-toggle="modal"><i class="fa fa-credit-card" data-toggle="tooltip" data-placement="top" data-original-title="'.$this->lang->line('productsale_add_payment').'"></i></a>';
                                                            }
                                                        } else {
                                                ...
                                                if(permissionChecker('productsale_view')) {
                                                    echo '<a href="#paymentlist" id="'.$productsale->productsaleID.'" class="btn btn-info btn-large mrg getpaymentinfobtn" rel="tooltip" data-toggle="modal"><i class="fa fa-list-ul" data-toggle="tooltip" data-placement="top" data-original-title="'.$this->lang->line('productsale_view_payments').'"></i></a>';
                                                }
                                            ?>
                                        </td>
                                    <?php } ?>
                            ...
                            <div class="form-group" id="productsalepaidpaymentmethoderrorDiv">
                                ...
                                <?php
                                    $paymentmethodArray = array(
                                        ...
                                        'cash' => $this->lang->line('productsale_cash'),
                                        'bank' => $this->lang->line('productsale_bank')
                                    );
...
<script type="text/javascript">
    ...
    $("#productsalepaidpaymentmethod").change(function () {
            var valu = this.value;
            if (valu == "cash") {
                $("#bank_payment_info").empty();
            } else if (valu == "bank") {
                $("#bank_payment_info").html('<label for="comments"><?= $this->lang->line('productsale_cheque_no') ?></label>'
                        + '<input type="text" class="form-control" id="bank_cheque_number" name="bank_cheque_number" placeholder="<?= $this->lang->line('productsale_cheque_no'); ?>" required="required"/>');
            }
        });
    });
