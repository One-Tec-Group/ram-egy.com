                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('parents_father_name')?></b> <a class="pull-right"><?=$profile->father_name?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('parents_father_profession')?></b> <a class="pull-right"><?=$profile->father_profession?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('parents_username')?></b> <a class="pull-right"><?=$profile->username?></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-sm-9">
                ...
                <hr>
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><b><?=$this->lang->line("parents_father_name")?></b></span><?=$profile->father_name?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><b><?=$this->lang->line("parents_father_profession")?></b></span><?=$profile->father_profession?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><b><?=$this->lang->line("parents_mother_name")?></b></span><?=$profile->mother_name?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><b><?=$this->lang->line("parents_mother_profession")?></b></span><?=$profile->mother_profession?></p>
                                    </div>
                ...
                <hr>
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><b><?=$this->lang->line("parents_email")?></b></span><?=$profile->email?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><b><?=$this->lang->line("parents_phone")?></b></span> <?=$profile->phone?></p>
                                    </div>
                                    <div class="profile-view-tab">
                                        <p><span><b><?=$this->lang->line("parents_address")?></b></span><?=$profile->address?></p>
                                    </div>
                                     <div class="profile-view-tab">
                                        <p><span></span></p>
                                    </div>
                ...
                <hr>
                                    ...
                                    <div class="profile-view-tab">
                                        <p><span><b><?=$this->lang->line("parents_username")?></b></span><?=$profile->username?></p>
                                    </div>
                                    
                                    <?php if(permissionChecker('parents_edit')) { echo btn_sm_edit('parents/edit/'.$profile->parentsID, $this->lang->line('parents_edit_password')); } 
                                    ?>
