                ...
                <?php if(count($teachers)) { ?>
                    <div id="hide-table">
                        <table class="table table-striped table-bordered table-hover dataTable no-footer">
                            <thead>
                                <tr>
                                    <th class="col-sm-1"><?=$this->lang->line('tattendance_registerNO')?></th>
                                    <th class="col-sm-2"><?=$this->lang->line('tattendance_photo')?></th>
                                    <th class="col-sm-2"><?=$this->lang->line('tattendance_name')?></th>
                                    <th class="col-sm-2"><?=$this->lang->line('tattendance_phone')?></th>
                            ...
                            <tbody id="list">
                                <?php if(count($teachers)) {$i = 1; foreach($teachers as $teacher) { if(isset($tattendances[$teacher->teacherID])) { ?>
                                    <tr>
                                        <td data-title="<?=$this->lang->line('tattendance_registerNO')?>">
                                            <?php echo $teacher->teacherRegisterNumber; ?>
                                        </td>
                                        ...
                                        <td data-title="<?=$this->lang->line('tattendance_phone')?>">
                                            ...
                                            <?php
                                                ...
                                                if(isset($tattendances[$teacher->teacherID])) {
                                                    if($monthyear == $tattendances[$teacher->teacherID]->monthyear && $tattendances[$teacher->teacherID]->teacherID == $teacher->teacherID) {
                                                        ...
                                                        echo  btn_attendance_radio($tattendances[$teacher->teacherID]->tattendanceID.'-1', $pmethod, "attendance btn btn-warning present", "attendance".$tattendances[$teacher->teacherID]->tattendanceID, $this->lang->line('tattendance_present'),'P');
?></br><?
