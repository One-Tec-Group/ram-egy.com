...
<?php if(count($teacher)) { ?>
    <div class="well">
        <div class="row">
            <div class="col-sm-6">
                <?php if(!permissionChecker('tattendance_view') && permissionChecker('tattendance_add')) { echo btn_sm_add('tattendance/add', $this->lang->line('tattendance_add')); } ?>

                <button class="btn-cs btn-sm-cs" onclick="javascript:printDiv('printablediv')"><span class="fa fa-print"></span> <?=$this->lang->line('print')?> </button>
                <?php echo btn_add_pdf('tattendance/print_preview/'.$teacher->teacherID, $this->lang->line('pdf_preview')); ?>
            </div>
            <div class="col-sm-6">
                <ol class="breadcrumb">
            ...
            <div class="col-sm-3">
                <div class="box box-primary">
                    <div class="box-body box-profile">
                        <?=profileviewimage($teacher->photo)?>
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('tattendance_sex')?></b> <a class="pull-right"><?=$teacher->sex?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('tattendance_dob')?></b> <a class="pull-right"><?=date('d M Y',strtotime($teacher->dob))?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('tattendance_phone')?></b> <a class="pull-right"><?=$teacher->phone?></a>
                            </li>
                        </ul>
                    </div>
                </div>
