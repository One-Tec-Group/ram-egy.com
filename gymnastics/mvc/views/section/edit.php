...
<div class="box">
    ...
    <div class="col-sm-6">
        ...
        <?php
        $array = array();
        $array[0] = $this->lang->line("section_select_teacher_first");

        foreach ($teachers as $teacher) {
            $array[$teacher->teacherID] = $teacher->name;
        }
        echo form_dropdown("firsTeacherID", $array, set_value("firsTeacherID", $section->teacherID), "id='teacherID' class='form-control select2'");
        ?>
    </div>
    <span class="col-sm-4 control-label">
...
<div class="col-sm-6">
    ...
    echo form_dropdown("secondTeacherID", $array, set_value("secondTeacherID", $section->teacherID_second), "id='teacherID' class='form-control select2'");
    ?>
</div>
<span class="col-sm-4 control-label">
...
<div class="col-sm-6">
    ...
    echo form_dropdown("thirdTeacherID", $array, set_value("thirdTeacherID", $section->teacherID_third), "id='teacherID' class='form-control select2'");
    ?>
</div>
<span class="col-sm-4 control-label">
...
<div class="col-sm-6">
    ...
    echo form_dropdown("goalkeeper_coach", $array, set_value("goalkeeper_coach", $section->goalkeeper_coach), "id='goalkeeper_coach' class='form-control select2 js-example-basic-multiple'");
    ?>
</div>
<span class="col-sm-4 control-label">
...
<div class="col-sm-6">
    ...
    echo form_dropdown("supervisor", $array, set_value("supervisor", $section->supervisor), "id='supervisor' class='form-control select2 js-example-basic-multiple'");
    ?>
</div>
<span class="col-sm-4 control-label">
...
<div class="col-sm-6">
    ...
    echo form_dropdown("supervisor2", $array, set_value("supervisor2", $section->supervisor2), "id='supervisor2' class='form-control select2 js-example-basic-multiple'");
    ?>
</div>
<span class="col-sm-4 control-label">
...
<div class="col-sm-6">
    <input type="text" class="form-control" id="monthlyFees" name="monthlyFees" value="<?= set_value('monthlyFees', $section->monthly_fees) ?>" >
</div>
<span class="col-sm-4 control-label">
