            ...
            <div class="row">
                ...
                <div class="col-sm-6">
                    <div class="box box-solid " style="border: 1px #ccc solid; border-left: 2px black solid">
                        ...
                        <div class="box-body">
                            <span class='text-blue'><?= $this->lang->line("classesreport_class_number_of_students_section") ?> : <?= count($students) ?></span><a class="text text-blue text-right pull-right" href="<?= base_url("student/index/" . $classID . "/" . $sectionID); ?>"><?= $this->lang->line("view") ?></a><br>
                            <span class='text-blue'><?= $this->lang->line("classesreport_class_number_of_students_class") ?> : <?= count($classStudents) ?></span><a class="text text-blue text-right pull-right" href="<?= base_url("student/index/" . $classID); ?>"><?= $this->lang->line("view") ?></a><br>
                        </div>
                    </div>
