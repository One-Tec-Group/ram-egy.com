                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php
                                $array = array();
                                $array[0] = $this->lang->line("class_select_supervisor1");

                                foreach ($supervisors as $supervisor) {
                                    $array[$supervisor->userID] = $supervisor->name;
                                }
                                echo form_dropdown("first_supervisor", $array, set_value("first_supervisor"), "id='first_supervisor' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    ?>
                        ...
                        <div class="col-sm-6">
                            ...
                            <?php
                                $array = array();
                                $array[0] = $this->lang->line("class_select_supervisor2");

                                foreach ($supervisors as $supervisor) {
                                    $array[$supervisor->userID] = $supervisor->name;
                                }
                                echo form_dropdown("second_supervisor", $array, set_value("second_supervisor"), "id='second_supervisor' class='form-control select2'");
                            ?>
                        </div>
                        <span class="col-sm-4 control-label">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-8">
                            <input type="submit" class="btn btn-success" onclick="$('#note').val($('.Editor-editor').html());" value="<?=$this->lang->line("add_class")?>" >
                        </div>
                    </div>
