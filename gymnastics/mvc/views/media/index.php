            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <label for="share_with" class="col-sm-3 control-label">
                        <?= $this->lang->line("share_with") ?> <span class="text-red">*</span>
                    </label>
                    <div class="col-sm-6">
                ...
                <label for="classesID" class="col-sm-3 control-label">
                    <?= $this->lang->line("select_class") ?> <span class="text-red">*</span>
                </label>
                <div class="col-sm-6">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" name="sub_folder" id="sub_folder" value="0"/>
                    <?php
                ...
                <div class="modal-body">
                    <div class='form-group' >
                        <label for="photo" class="col-sm-3 control-label col-xs-8 col-md-2">
                            <?= $this->lang->line("file") ?> <span class="text-red">*</span>
                        </label>
