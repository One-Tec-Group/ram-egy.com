            ...
            <div class="col-sm-12">
                ...
                <div id="hide-table">
                    <table id="example1" class="table table-striped table-bordered table-hover dataTable no-footer">
                        <thead>
                            <tr>
                                <th class="col-sm-1"><?=$this->lang->line('teacher_registerNO')?></th>
                        ...
                        <tbody>
                            <?php if(count($teachers)) {$i = 1; foreach($teachers as $teacher) { ?>
                                <tr>
                                    <td data-title="<?=$this->lang->line('teacher_registerNO')?>">
                                    ...
                                    <td data-title="<?=$this->lang->line('action')?>">
                                        <?php 
                                        echo anchor('teacher/view/' . $teacher->teacherID . '/?tab=files', "<i class='fa fa-file-o'></i>", "class='btn btn-primary btn-large mrg' data-placement='top' data-toggle='tooltip' data-original-title='View Files'");
