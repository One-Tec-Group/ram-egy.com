<div class="well">
    <div class="row">
        <div class="col-sm-6">
            <?php if(!permissionChecker('sattendance_view') && permissionChecker('sattendance_add')) { echo btn_sm_add('sattendance/add', $this->lang->line('attendance_add')); } ?>
                    ...
                    <div class="box-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('attendance_registerNO')?></b> <a class="pull-right"><?=$student->srregisterNO?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('attendance_roll')?></b> <a class="pull-right"><?=$student->srroll?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('attendance_classes')?></b> <a class="pull-right"><?=count($classes) ? $classes->classes : ''?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('attendance_section')?></b> <a class="pull-right"><?=count($section) ? $section->section : ''?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('attendance_phone')?></b> <a class="pull-right"><?=$student->phone?></a>
                            </li>
                            <li class="list-group-item" style="background-color: #FFF">
                                <b><?=$this->lang->line('attendance_dob')?></b> <a class="pull-right"><?=$student->dob?></a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-sm-9">
                <div class="nav-tabs-custom">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#attendance" data-toggle="tab"><?=$this->lang->line('attendance_attendance')?></a></li>
                    </ul>
