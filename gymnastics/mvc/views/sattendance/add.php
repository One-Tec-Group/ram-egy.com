            ...
            <div class="col-sm-12">
                ...
                <?php if(count($sattendanceinfo)) { ?>
                    <div class="col-sm-4 col-sm-offset-4 box-layout-fame">
                        <?php
                            echo '<h5><center>'. $sattendanceinfo['class'].'</center></h5>';
                            echo '<h5><center>'. $sattendanceinfo['section'].'</center></h5>';
                            if($setting->attendance == "subject") {
                                echo '<h5><center>'. $sattendanceinfo['subject'].'</center></h5>';
                            }
                            echo '<h5><center>'. $sattendanceinfo['day'].'</center></h5>';
                            echo '<h5><center>'. $sattendanceinfo['date'].'</center></h5>';
                        ?>
                    </div>
                <?php } ?>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-1"><?=$this->lang->line('attendance_dob')?></th>
                                <th class="col-sm-2">
                        ...
                        <tbody id="list">
                            <?php if(count($students)) {$i = 1; foreach($students as $student) { if(isset($attendances[$student->studentID])) { ?>
                                <tr>
                                    ...
                                    <td data-title="<?=$this->lang->line('attendance_dob')?>">
