                ...
                <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
                    ...
                    <?php
                        ...
                        <label for="moneyBalance" class="col-sm-2 control-label">
                            <?= $this->lang->line("expense_balance") ?>
                            <span class="text-red">*</span>
                        </label>
                        <div class="col-sm-6">
                            <select class="form-control" id="moneyBalance" name="moneyBalance">
                                <option disabled value selected>SELECT BALANCE</option>
                                <option<?php echo (($expense->balance == "bank")?" selected='selected'":""); ?> value="bank">Bank</option>
                                <option<?php echo (($expense->balance == "cash")?" selected='selected'":""); ?> value="cash">Cash</option>
                            </select>
                        </div>
                        <span class="col-sm-4 control-label">
