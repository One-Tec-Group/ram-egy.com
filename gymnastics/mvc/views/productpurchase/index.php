                                        ...
                                        <td data-title="<?=$this->lang->line('action')?>">
                                            <?php
                                                    ...
                                                    if(permissionChecker('productpurchase_add')) {
                                                        if(isset($grandtotalandpaid['grandtotal'][$productpurchase->productpurchaseID]) && isset($grandtotalandpaid['totalpaid'][$productpurchase->productpurchaseID])) {
                                                            if((float)$grandtotalandpaid['grandtotal'][$productpurchase->productpurchaseID] > (float)$grandtotalandpaid['totalpaid'][$productpurchase->productpurchaseID]) {
                                                                echo '<a href="#addpayment" id="'.$productpurchase->productpurchaseID.'" class="btn btn-primary btn-large mrg getpurchaseinfobtn" rel="tooltip" data-toggle="modal"><i class="fa fa-credit-card" data-toggle="tooltip" data-placement="top" data-original-title="'.$this->lang->line('productpurchase_add_payment').'"></i></a>';
                                                            }
                                                        } else {
                                                ...
                                                if(permissionChecker('productpurchase_view')) {
                                                    echo '<a href="#paymentlist" id="'.$productpurchase->productpurchaseID.'" class="btn btn-info btn-large mrg getpaymentinfobtn" rel="tooltip" data-toggle="modal"><i class="fa fa-list-ul" data-toggle="tooltip" data-placement="top" data-original-title="'.$this->lang->line('productpurchase_view_payments').'"></i></a>';
                                                }
                                            ?>
                                        </td>
                                    <?php } ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                            ...
                            <div class="form-group" id="productpurchasepaidpaymentmethoderrorDiv">
                                ...
                                <?php
                                    $paymentmethodArray = array(
                                        ...
                                        'cash' => $this->lang->line('productpurchase_cash'),
                                        'bank' => $this->lang->line('productpurchase_bank')
                                    );
                    ...
                    <div id="bank_payment_info" class="col-sm-6 <?= form_error('bank_cheque_number') ? 'has-error' : '' ?>"></div>
...
<script type="text/javascript">
    ...
    $("#productpurchasepaidpaymentmethod").change(function () {
            var valu = this.value;
            if (valu == "cash") {
                $("#bank_payment_info").empty();
            } else if (valu == "bank") {
                $("#bank_payment_info").html('<label for="comments"><?= $this->lang->line('productpurchase_cheque_no') ?></label>'
                        + '<input type="text" class="form-control" id="bank_cheque_number" name="bank_cheque_number" placeholder="<?= $this->lang->line('productpurchase_cheque_no'); ?>" required="required"/>');
            }
        });
    });
</script>
