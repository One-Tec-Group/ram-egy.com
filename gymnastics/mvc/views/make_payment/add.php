                ...
                <div class="box-body">
                    <form role="form" method="post">
                        ...
                        <div class="form-group <?= form_error('payment_amount') ? 'has-error' : '' ?>">
                            <label for="payment_amount"><?= $this->lang->line('make_payment_payment_amount') ?> <span class="text-red">*</span></label> <?php
                            if ($manage_salary->salary == 2) {
                                echo '<span id="hourdis"></span>';
                            }
                            ?>
                        ...
                        <div class="form-group <?= form_error('payment_type') ? 'has-error' : '' ?>">
                            <label for="payment_type"><?= $this->lang->line('make_payment_payment_method') ?> <span class="text-red">*</span></label>
                            <?php
                            $paymentArray = array(
                                '0' => $this->lang->line('make_payment_select_payment_method'),
                                'cash' => $this->lang->line('make_payment_payment_cash'),
                                'bank' => $this->lang->line('make_payment_payment_bank'),
                            );

                            echo form_dropdown("payment_type", $paymentArray, set_value("payment_type"), "id='payment_type' class='form-control'");
                            ?>
                            <span class="text-red">
                        ...
                        <div id="bank_payment_info" class="form-group <?= form_error('bank_cheque_number') ? 'has-error' : '' ?>"></div>
                        ...
                        <input type="hidden" name="user_username" value="<?= $user->name ?>">
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="col-sm-3"><?php
                                    if ($manage_salary->salary == 2) {
                                        echo $this->lang->line('make_payment_net_salary_hourly');
                                    } else {
                                        echo $this->lang->line('make_payment_net_salary');
                                    }
                                    ?></th>
    ...
    $(document).ready(function () {
        ...
        $("#payment_type").change(function () {
            ...
            if (valu == "cash") {
                ...
                $("#bank_payment_info").html('<label for="comments"><?= $this->lang->line('make_payment_payment_cheque_number') ?></label>'
                        + '<input type="text" class="form-control" id="bank_cheque_number" name="bank_cheque_number" placeholder="<?= $this->lang->line('make_payment_payment_cheque_number'); ?>" required="required"/>');
            }
        });
