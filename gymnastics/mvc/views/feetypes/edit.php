...
<div class="box">
    ...
    <div class="box-body">
        <div class="row">
            ...
            <?php
            if (form_error('feetypes_amount'))
                echo "<div class='form-group has-error' >";
            else
                echo "<div class='form-group' >";
            ?>
            <label for="feetypes_amount" class="col-sm-2 control-label">
                <?= $this->lang->line("feetypes_amount") ?> <span class="text-red">*</span>
            </label>
            <div class="col-sm-6">
                <input type="text" class="form-control" id="feetypes_amount" name="feetypes_amount" value="<?= set_value('feetypes_amount', $feetypes->feeAmount) ?>" >
            </div>
            <span class="col-sm-4 control-label">
                <?php echo form_error('feetypes_amount'); ?>
            </span>
        </div>
