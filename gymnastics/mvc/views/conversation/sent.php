                        ...
                        <table id="withoutBtn" class="table table-hover dataTable no-footer">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="3"><?=$this->lang->line('attach')?></th>
                            ...
                            <?php if(count($messages)) {$i = 1; foreach($messages as $message) { ?>
                                <tr class="<?=$message->reply_status==1 ? "unread" : "read"?>">
                                  ...
                                  <td data-title="<?=$this->lang->line('attach')?>" class="mailbox-attachment"><?php if ($message->attach1 != '') {?><i class="fa fa-paperclip"></i><?php } ?></td>
                                  <td data-title="<?=$this->lang->line('attach')?>" class="mailbox-attachment"><?php if ($message->attach2 != '') {?><i class="fa fa-paperclip"></i><?php } ?></td>
                                  <td data-title="<?=$this->lang->line('attach')?>" class="mailbox-attachment"><?php if ($message->attach3 != '') {?><i class="fa fa-paperclip"></i><?php } ?></td>
