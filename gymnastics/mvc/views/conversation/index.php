                            ...
                            <?php if ($conversations): ?>
                                <?php if(count($conversations)) {$i = 1; foreach($conversations as $conversation) { ?>
                                    <tr class="">
                                        ...
                                        <td data-title="<?=$this->lang->line('attach')?>" class="mailbox-attachment"><?php if ($conversation->attach1 != '') {?><i class="fa fa-paperclip"></i><?php } ?></td>
                                        <td data-title="<?=$this->lang->line('attach')?>" class="mailbox-attachment"><?php if ($conversation->attach3 != '') {?><i class="fa fa-paperclip"></i><?php } ?></td>
                                        <td data-title="<?=$this->lang->line('attach')?>" class="mailbox-attachment"><?php if ($conversation->attach3 != '') {?><i class="fa fa-paperclip"></i><?php } ?></td>
