            ...
            if ($this->form_validation->run() == FALSE) {
                ...
                if ($_FILES["attachment1"]['name'] != "") {
                    ...
                    if (count($explode) >= 2) {
                        ...
                        $conversation_msg['attach1'] = $file_name;
                        $conversation_msg['attach_file_name1'] = $new_file;
                ...
                if ($_FILES["attachment2"]['name'] != "") {
                    ...
                    if (count($explode) >= 2) {
                        ...
                        $config['max_width'] = '5000';
                        $config['max_height'] = '5000';
                        $conversation_msg['attach2'] = $file_name;
                        $conversation_msg['attach_file_name2'] = $new_file;
                        $this->load->library('upload', $config);
                ...
                if ($_FILES["attachment3"]['name'] != "") {
                    $file_name = $_FILES["attachment3"]['name'];
                    $file_name_rename = random19();
                    $explode = explode('.', $file_name);
                    if (count($explode) >= 2) {
                        $new_file = $file_name_rename . '.' . end($explode);
                        ...
                        $config['max_width'] = '5000';
                        $config['max_height'] = '5000';
                        $conversation_msg['attach4'] = $file_name;
                        $conversation_msg['attach_file_name4'] = $new_file;
                        $this->load->library('upload', $config);
                ...
                if ($_FILES["attachment4"]['name'] != "") {
                    $file_name = $_FILES["attachment4"]['name'];
                    $file_name_rename = random19();
                    $explode = explode('.', $file_name);
                    if (count($explode) >= 2) {
                        $new_file = $file_name_rename . '.' . end($explode);
                        ...
                        $config['max_width'] = '5000';
                        $config['max_height'] = '5000';
                        $conversation_msg['attach3'] = $file_name;
                        $conversation_msg['attach_file_name3'] = $new_file;
                        $this->load->library('upload', $config);
    ...
    public function view() {
        ...
        if ((int) $id) {
            ...
            if (count($check) == 1) {
                if ($check->trash != 2) {
                    if ($_POST) {
                        if ($_POST['reply'] || $_FILES["attachment1"]['name'] != "" || $_FILES["attachment2"]['name'] != "" || $_FILES["attachment3"]['name'] != "" || $_FILES["attachment4"]['name'] != "") {
                            $array = array();
                            ...
                            if ($_FILES["attachment1"]['name'] != "") {
                                ...
                                if (count($explode) >= 2) {
                                    ...
                                    $config['max_width'] = '5000';
                                    $config['max_height'] = '5000';
                                    $array['attach1'] = $file_name;
                                    $array['attach_file_name1'] = $new_file;
                                    $this->load->library('upload', $config);
                                    if (!$this->upload->do_upload("attachment1")) {
                                        $this->data["attachment_error"] = $this->upload->display_errors();
                                        $this->session->set_flashdata('error', $this->data["attachment_error"]);
                            ...
                            if ($_FILES["attachment2"]['name'] != "") {
                                ...
                                if (count($explode) >= 2) {
                                    ...
                                    $config['max_width'] = '5000';
                                    $config['max_height'] = '5000';
                                    $array['attach2'] = $file_name;
                                    $array['attach_file_name2'] = $new_file;
                                    $this->load->library('upload', $config);
                                    if (!$this->upload->do_upload("attachment2")) {
                                        $this->data["attachment_error"] = $this->upload->display_errors();
                                        $this->session->set_flashdata('error', $this->data["attachment_error"]);
                            ...
                            if ($_FILES["attachment3"]['name'] != "") {
                                ...
                                if (count($explode) >= 2) {
                                    ...
                                    $config['max_width'] = '5000';
                                    $config['max_height'] = '5000';
                                    $array['attach4'] = $file_name;
                                    $array['attach_file_name4'] = $new_file;
                                    $this->load->library('upload', $config);
                                    if (!$this->upload->do_upload("attachment3")) {
                                        $this->data["attachment_error"] = $this->upload->display_errors();
                                        $this->session->set_flashdata('error', $this->data["attachment_error"]);
                            ...
                            if ($_FILES["attachment4"]['name'] != "") {
                                ...
                                if (count($explode) >= 2) {
                                    ...
                                    $config['max_width'] = '5000';
                                    $config['max_height'] = '5000';
                                    $array['attach3'] = $file_name;
                                    $array['attach_file_name3'] = $new_file;
                                    $this->load->library('upload', $config);
                                    if (!$this->upload->do_upload("attachment4")) {
                                        $this->data["attachment_error"] = $this->upload->display_errors();
                                        $this->session->set_flashdata('error', $this->data["attachment_error"]);
