		...
		if(permissionChecker('classesreport')) {
			if($_POST) {
				...
				if($this->form_validation->run() == FALSE) {
					...
					$studentArrayClass = array("srclassesID" => $classID, "srschoolyearID" => $schoolyearID);
                                        $classStudents = pluck($this->studentrelation_m->general_get_order_by_student($studentArrayClass), 'obj', 'srstudentID');
					...
					$this->data['classStudents'] = $classStudents;
