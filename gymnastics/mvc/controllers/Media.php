...
*/
	...
	public function index() {
		...
		if($this->data['usertypeID'] == 1) {
			...
			$this->data['folders'] = $this->media_category_m->get_order_by_mcategory(array('userID'=> $this->data['userID'], 'usertypeID'=>$this->data['usertypeID'],'sub_folder'=>'0'));
	...
	public function create_folder() {
		if(permissionChecker('media_add')) {
			...
			$array['folder_name'] = $this->input->post('folder_name');
                        $array['sub_folder'] = $this->input->post('sub_folder');
