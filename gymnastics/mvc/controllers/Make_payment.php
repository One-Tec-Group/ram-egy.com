                                ...
                                if (($this->data['siteinfos']->school_year == $this->session->userdata('defaultschoolyearID')) || ($this->session->userdata('usertypeID') == 1)) {
                                    ...
                                    if ($this->form_validation->run() == FALSE) {
                                        ...
                                        if ($this->input->post("payment_type") == "cash") {
                                            $array['cheque_number'] = '-';
                                        } else if ($this->input->post("payment_type") == "bank") {
                                            $array['cheque_number'] = $this->input->post('bank_cheque_number');
                                        }
                                        ...
                                        $array = array(
                                            "expense" => $this->input->post("user_username") . "(" . $this->input->post("month") . ")",
                                            "amount" => $this->input->post('payment_amount'),
                                            "balance" => $this->input->post("payment_type"),
