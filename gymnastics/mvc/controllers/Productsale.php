                    ...
                    if ($_POST) {
                        ...
                        if ($this->form_validation->run() == FALSE) {
                            ...
                            $array = array(
                                ...
                                'payment' => $this->input->post('productsalepaidpaymentmethod'),
                            ...
                            if($this->input->post('bank_cheque_number') != null){
                                $array['transactionno'] = $this->input->post('bank_cheque_number');
                            }else{
                                $array['transactionno'] = "-";
                            }
                            ...
                            $array['name'] = "Product Sale (" . $this->input->post('productsalepaidreferenceno') . ")";
                            $array['date'] = date("Y-m-d", strtotime($this->input->post("productsalepaiddate")));
                            $array['incomeday'] = date("d", strtotime($this->input->post("productsalepaiddate")));
                            $array['incomemonth'] = date("m", strtotime($this->input->post("productsalepaiddate")));
                            $array['incomeyear'] = date("Y", strtotime($this->input->post("productsalepaiddate")));
                            $array['amount'] = $this->input->post('productsalepaidamount');
                            $array['balance'] = $this->input->post('productsalepaidpaymentmethod');
                            ...
                            if($this->input->post('bank_cheque_number') != null){
                                $array['note'] = $this->input->post('bank_cheque_number');
                            }else{
                                $array['note'] = "-";
                            }
