                    ...
                    if ($_POST) {
                        ...
                        if ($this->form_validation->run() == FALSE) {
                            ...
                            $array = array(
                                ...
                                'balance' => $this->input->post('productpurchasepaidpaymentmethod'),
                                'transaction' => $this->input->post('bank_cheque_number'),
                            ...
                            $array = array(
                                "expense" => "Product Purchase (" . $this->input->post("productpurchasepaidreferenceno") . ")",
                                "amount" => $this->input->post('productpurchasepaidamount'),
                                "balance" => $this->input->post("productpurchasepaidpaymentmethod"),
                                "note" => "",
                                "create_date" => date("Y-m-d"),
                                "date" => date("Y-m-1", strtotime($this->input->post("productpurchasepaiddate"))),
                                "expenseday" => date("d", strtotime($this->input->post("productpurchasepaiddate"))),
                                "expensemonth" => date("m", strtotime($this->input->post("productpurchasepaiddate"))),
                                "expenseyear" => date("Y", strtotime($this->input->post("productpurchasepaiddate"))),
