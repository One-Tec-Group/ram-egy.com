...
class Payment_m extends MY_Model {
	...
	public function get_payment_with_student_by_studentID($studentID, $schoolyearID) {
		$this->db->select('payment.*, invoice.invoiceID, invoice.feetype, invoice.amount, student.*');
		$this->db->from('payment');
		$this->db->join('student', 'student.studentID = payment.studentID AND student.schoolyearID = payment.schoolyearID', 'LEFT');
	...
	public function get_payment_with_student($schoolyearID) {
		$this->db->select('payment.*, invoice.invoiceID, invoice.feetype, invoice.amount, student.*');
		$this->db->from('payment');
		$this->db->join('student', 'student.studentID = payment.studentID AND student.schoolyearID = payment.schoolyearID', 'LEFT');
		$this->db->join('invoice', 'invoice.invoiceID = payment.invoiceID', 'LEFT');
